          ...
          <div className="review-form-container">
            ...
            <div className="review-form">
              ...
              <div className="review-info">
                ...
                <input type="text" onChange={this.setHeadline()} placeholder="What's most important to know?"></input>
                <h3>Add a written review</h3>
                <textarea onChange={this.setText()} placeholder="What did you like or dislike? What did you use this product for?"/>
